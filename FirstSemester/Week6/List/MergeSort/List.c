...
void setAt(List* const list, const size_t index, const char* const name, const char* const phone)
{
    ListElement* currentElement = list->begin;
    ...
    strcpy(currentElement->value[0], name);
    strcpy(currentElement->value[1], phone);
}

char* getAt(const List* const list, const size_t index, const size_t indexEntry)
{
    ListElement* currentElement = list->begin;
    for (size_t i = 0; i < index; i++)
    {
    ...
    return currentElement->value[indexEntry];
}
